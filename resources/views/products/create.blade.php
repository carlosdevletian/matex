			...
			<div class="col-xs-12">
				<form method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
                    <div class="form-group {{ $errors->has('file') ? 'has-error' : ''}}">
                        ...
                        <input type="file" name="file" id="file" class="dropify" data-height="115" data-max-file-size="10M" data-allowed-file-extensions="png jpg jpeg gif" data-max-file-size-preview="10M" />
					</div>
